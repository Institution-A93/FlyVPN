...
- [`config-api/`](./config-api/readme.md) — выдача по коду Plati/Digiseller, генерация .mobileconfig, выдача кредов (MMVP legacy).
- [`account-api/`](./account-api/readme.md) — веб-кабинет MVP: аккаунты/сессии, подписки/квота, устройства, платежи Platega (ADR-0020).
- [`orchestrator/`](./orchestrator/readme.md) — реестр узлов, health-check, ротация секретов/узлов + cron-обязанности MVP.
